...
defineEmits(['vaciar-carrito', 'decrementar-cantidad', 'incrementar-cantidad', 'agregar-carrito', 'eliminar-guitarra']);
                  ...
                  <tbody>
                    <tr v-for="guitarra in carrito" :key="guitarra.id">
                      ...
                      <td class="flex align-items-start gap-4">
                        <button @click="$emit('decrementar-cantidad', guitarra.id)" type="button" class="btn btn-dark">
                          -
                        </button>
                        {{ guitarra.cantidad }}
                        <button @click="$emit('incrementar-cantidad', guitarra.id)" type="button" class="btn btn-dark">
                          +
                        </button>
                      </td>
                      <td>
                        <button @click="$emit('eliminar-guitarra', guitarra.id)" class="btn btn-danger" type="button">
                          X
                        </button>
                      </td>
                    </tr>
